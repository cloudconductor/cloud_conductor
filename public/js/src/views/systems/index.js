...
//
define(['extended-view', 'jst', 'src/collections/systems'], function(ExtendedView, JST, Systems) {
  'use strict';
  ...
  return ExtendedView.extend({
    events: {
      ...
      "click .nextPage": function() {
        this.collection.getNextPage(); return false;
      },
    ...
    appendItem: function(template) {
      this.$("#system_items").append(this.itemTemplate(template.attributes));
    },
  });
});
