...
module CloudConductor
  describe Client do
    ...
    describe '#create_stack' do
      before do
        allow(pattern_history).to receive(:clone_repository).and_yield('/tmp/patterns')
      ...
      it 'call adapter#create_stack with same arguments without pattern' do
        ...
        @client.create_stack 'stack_name', pattern_history, {}
      end
      ...
      it 'add ImageId/Image pair to parameter-hash' do
        image1 = pattern_history.images.first
        image2 = FactoryGirl.create(:image, pattern_history: pattern_history, cloud: cloud)
      ...
      it 'use key of ImageId that remove special characters from image.role' do
        FactoryGirl.create(:image, pattern_history: pattern_history, cloud: cloud, role: 'web, ap, db')
        expected_parameters = satisfy do |parameters|
    ...
    describe '#update_stack' do
      ...
      it 'call adapter#update_stack with same arguments without pattern' do
        ...
        @client.update_stack 'stack_name', pattern_history, {}
      end
