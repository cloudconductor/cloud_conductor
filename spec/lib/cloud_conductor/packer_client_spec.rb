  ...
  describe PackerClient do
    ...
    describe '#parse' do
      before do
        ...
        @base_image_aws = FactoryGirl.build(:base_image, cloud: @cloud_aws, platform: 'centos')
        @base_image_openstack = FactoryGirl.build(:base_image, cloud: @cloud_openstack, platform: 'centos')
      end
